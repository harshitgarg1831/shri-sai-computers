    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center mb-20">
                <h1 className="text-5xl font-black text-gray-700  mb-6 tracking-tight">Expert Repair Services</h1>
                <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">Fast, reliable, and professional repair services for your laptops and desktops. Our certified technicians can handle any issue.</p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                <div>
                    <h2 className="text-3xl font-extrabold text-slate-900 mb-8 border-b pb-4">What We Repair</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:border-blue-500 transition cursor-pointer">
                            ...
                            <h3 className="font-bold text-lg mb-2 text-gray-700">Hardware Issues</h3>
                            <p className="text-slate-600 text-sm">Screen, keyboard, battery, and motherboard replacements.</p>
                        </div>
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:border-blue-500 transition cursor-pointer">
                            ...
                            <h3 className="font-bold text-lg mb-2 text-gray-700">OS & Software</h3>
                            <p className="text-slate-600 text-sm">OS Installation, formatting, data recovery, and drivers.</p>
                        </div>
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:border-blue-500 transition cursor-pointer">
                            <div className="bg-blue-50 text-blue-600 w-12 h-12 rounded-xl flex items-center justify-center font-bold text-xl mb-4">🛡️</div>
                            <h3 className="font-bold text-lg mb-2 text-gray-700">Virus Removal</h3>
                            <p className="text-slate-600 text-sm">Malware cleaning, antivirus setup, and system optimization.</p>
                        </div>
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:border-blue-500 transition cursor-pointer">
                            <div className="bg-blue-50 text-blue-600 w-12 h-12 rounded-xl flex items-center justify-center font-bold text-xl mb-4">🚀</div>
                            <h3 className="font-bold text-lg mb-2 text-gray-700">Upgrades</h3>
                            <p className="text-slate-600 text-sm">RAM, SSD upgrades for faster and smoother performance.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-10 rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50 relative overflow-hidden">
                    ...
                    <h2 className="text-3xl font-extrabold text-slate-900 mb-8 relative z-10">Request a Repair</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input required name="name" value={formData.name} onChange={handleChange} type="text" className="w-full border border-slate-300 rounded-lg shadow-sm p-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition outline-none  text-gray-700" placeholder="Name" />
                            </div>
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-2">Phone</label>
                                <input required name="phone" value={formData.phone} onChange={handleChange} type="tel" className="w-full border border-slate-300 rounded-lg shadow-sm p-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition outline-none  text-gray-700" placeholder="Phone" />
                            </div>
                        </div>
                        {/* <div>
