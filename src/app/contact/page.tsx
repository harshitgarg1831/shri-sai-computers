    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center mb-16">
                <h1 className="text-5xl font-black text-[lab(35_-16.57_-8.25)] mb-6 tracking-tight">Contact Us</h1>
                <p className="text-xl text-[lab(35_-16.57_-8.25)] max-w-2xl mx-auto">Have a question or need assistance? Reach out to us. We're always here to help.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto">
                <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 text-center">
                    ...
                    <h3 className="text-xl font-bold text-[lab(35_-16.57_-8.25)] mb-3">Our Location</h3>
                    <p className="text-[lab(35_-16.57_-8.25)]">Purana Bazar, Bari</p>
                </div>
                <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 text-center">
                    <div className="w-16 h-16 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center mx-auto mb-6 text-2xl">📞</div>
                    <h3 className="text-xl font-bold text-[lab(35_-16.57_-8.25)] mb-3">Phone & WhatsApp</h3>
                    <p className="text-[lab(35_-16.57_-8.25)]">+91-8302635500<br />Mon-Sat: 10AM - 8PM</p>
                </div>
                <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 text-center">
                    ...
                    <h3 className="text-xl font-bold text-[lab(35_-16.57_-8.25)] mb-3">Email Us</h3>
                    <p className="text-[lab(35_-16.57_-8.25)]">shrisaicomputersbari@gmail.com</p>
                </div>
            </div>
