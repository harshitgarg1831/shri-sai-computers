        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="flex flex-col justify-center">
                    ...
                    <h1 className="text-4xl font-extrabold text-[lab(35_-16.57_-8.25)] mb-4 leading-tight">{product.name}</h1>
                    <p className="text-3xl font-black text-[lab(35_-16.57_-8.25)] mb-8">₹{product.price}</p>
                    <p className="text-[lab(35_-16.57_-8.25)] mb-8 text-lg leading-relaxed">{product.description}</p>

                    {product.specs && product.specs.length > 0 && (
                        <div className="mb-8">
                            <h3 className="font-bold text-[lab(35_-16.57_-8.25)] mb-4 text-lg">Key Specifications</h3>
                            <ul className="grid grid-cols-2 gap-3">
                                {product.specs.map((spec: string, i: number) => (
                                    <li key={i} className="flex items-center text-[lab(35_-16.57_-8.25)] bg-slate-50 p-3 rounded-lg border border-slate-100 font-medium">
                    ...
                    <div className="bg-white border border-slate-200 shadow-sm rounded-2xl p-8">
                        <h3 className="text-xl font-bold mb-6 text-[lab(35_-16.57_-8.25)] border-b border-slate-100 pb-4">Enquire About This Product</h3>
