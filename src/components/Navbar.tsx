                ...
                <div className="flex justify-between h-16">
                    <div className="flex">
                        <Link href="/" className="flex-shrink-0 flex items-center gap-2">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGKvuf0RkbWvDapGPXhzQJdJHrK02xU0VZwA&s" alt="Shri Sai Computers Logo" className="h-8 sm:h-10 w-auto rounded-md object-contain" />
